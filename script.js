...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        // selecting USD by default as FROM currency and DOP as TO currency
        let selected = i == 0 ? currency_code == "USD" ? "selected" : "" : currency_code == "DOP" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/b282e6db78276a20773602ce/latest/${fromCurrency.value}`;
